...
describe('PassiveAffirmative', () => {

    it('Ichidan Verb', () => {
        const word = new Word('食べる', 'たべる', WordType.IchidanVerb)
        const result = new PassiveAffirmative().getConjugation(word)
    ...
    it('Godan Verb [う]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('会われる', 'あわれる', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [つ]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('待たれる', 'またれる', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [る]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('取られる', 'とられる', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [む]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('読まれる', 'よまれる', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [ぶ]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('遊ばれる', 'あそばれる', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [ぬ]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('死なれる', 'しなれる', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [く]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('書かれる', 'かかれる', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [ぐ]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('泳がれる', 'およがれる', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [す]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('話される', 'はなされる', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [行く]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('行かれる', 'いかれる', WordType.GodanVerb))
    });
    ...
    it('Suru Verb', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('勉強される', 'べんきょうされる', WordType.SuruVerb))
    });
