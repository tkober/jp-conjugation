...
describe('TeFormAffirmative', () => {
    ...
    it('Godan Verb [う]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('会って', 'あって', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [つ]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('待って', 'まって', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [る]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('取って', 'とって', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [む]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('読んで', 'よんで', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [ぶ]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('遊んで', 'あそんで', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [ぬ]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('死んで', 'しんで', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [く]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('書いて', 'かいて', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [ぐ]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('泳いで', 'およいで', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [す]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('話して', 'はなして', WordType.GodanVerb))
    });
    ...
    it('Godan Verb [行く]', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('行って', 'いって', WordType.GodanVerb))
    });
    ...
    it('Suru Verb', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('勉強して', 'べんきょうして', WordType.SuruVerb))
    });
    ...
    it('Kuru Verb', () => {
        ...
        expect(result !== undefined).toBeTruthy()
        expect(result).toEqual(new Word('来て', 'きて', WordType.KuruVerb))
    });
})
